...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h3 class="card-title">Thêm bánh</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('cakes.store') }}" method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <table class="table table-bordered table-hover" id="selected-packagings">
                        ...
                        <tbody>
                        <!-- Danh sách bao bì sẽ được thêm động bằng JavaScript -->
                        </tbody>
                    </table>
                </div>

                <button type="submit" class="btn btn-primary btn-lg">Thêm bánh</button>
            </form>
        </div>
    </div>
@endsection
